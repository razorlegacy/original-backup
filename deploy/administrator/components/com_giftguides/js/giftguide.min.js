...
/* Uploadify - File uploader */
jQuery&&function(b){b.extend(b.fn,{uploadify:function(h){b(this).each(function(){var a=b.extend({id:b(this).attr("id"),uploader:"../swf/uploadify.swf",script:"../classes/uploadify.php",expressInstall:null,folder:"",height:30,width:120,cancelImg:"../images/cancel.png",wmode:"opaque",scriptAccess:"sameDomain",fileDataName:"Filedata",method:"POST",queueSizeLimit:999,simUploadLimit:1,queueID:false,displayData:"percentage",removeCompleted:true,onInit:function(){},onSelect:function(){},onSelectOnce:function(){}, onQueueFull:function(){},onCheck:function(){},onCancel:function(){},onClearQueue:function(){},onError:function(){},onProgress:function(){},onComplete:function(){},onAllComplete:function(){}},h);b(this).data("settings",a);var i=location.pathname;i=i.split("/");i.pop();i=i.join("/")+"/";var f={};f.uploadifyID=a.id;f.pagepath=i;if(a.buttonImg)f.buttonImg=escape(a.buttonImg);if(a.buttonText)f.buttonText=escape(a.buttonText);if(a.rollover)f.rollover=true;f.script=a.script;f.folder=escape(a.folder);if(a.scriptData){var n= "",k;for(k in a.scriptData)n+="&"+k+"="+a.scriptData[k];f.scriptData=escape(n.substr(1))}f.width=a.width;f.height=a.height;f.wmode=a.wmode;f.method=a.method;f.queueSizeLimit=a.queueSizeLimit;f.simUploadLimit=a.simUploadLimit;if(a.hideButton)f.hideButton=true;if(a.fileDesc)f.fileDesc=a.fileDesc;if(a.fileExt)f.fileExt=a.fileExt;if(a.multi)f.multi=true;if(a.auto)f.auto=true;if(a.sizeLimit)f.sizeLimit=a.sizeLimit;if(a.checkScript)f.checkScript=a.checkScript;if(a.fileDataName)f.fileDataName=a.fileDataName; if(a.queueID)f.queueID=a.queueID;if(a.onInit()!==false){b(this).css("display","none");b(this).after('<div id="'+b(this).attr("id")+'Uploader"></div>');swfobject.embedSWF(a.uploader,a.id+"Uploader",a.width,a.height,"9.0.24",a.expressInstall,f,{quality:"high",wmode:a.wmode,allowScriptAccess:a.scriptAccess},{},function(c){typeof a.onSWFReady=="function"&&c.success&&a.onSWFReady()});a.queueID==false?b("#"+b(this).attr("id")+"Uploader").after('<div id="'+b(this).attr("id")+'Queue" class="uploadifyQueue"></div>'): b("#"+a.queueID).addClass("uploadifyQueue")}typeof a.onOpen=="function"&&b(this).bind("uploadifyOpen",a.onOpen);b(this).bind("uploadifySelect",{action:a.onSelect,queueID:a.queueID},function(c,d,g){if(c.data.action(c,d,g)!==false){var e=Math.round(g.size/1024*100)*0.01,j="KB";if(e>1E3){e=Math.round(e*0.0010*100)*0.01;j="MB"}e=e.toString().split(".");e=e.length>1?e[0]+"."+e[1].substr(0,2):e[0];fileName=g.name.length>20?g.name.substr(0,20)+"...":g.name;queue="#"+b(this).attr("id")+"Queue";if(c.data.queueID)queue= "#"+c.data.queueID;b(queue).append('<div id="'+b(this).attr("id")+d+'" class="uploadifyQueueItem"><div class="cancel"><a href="javascript:jQuery(\'#'+b(this).attr("id")+"').uploadifyCancel('"+d+'\')"><img src="'+a.cancelImg+'" border="0" /></a></div><span class="fileName">'+fileName+" ("+e+j+')</span><span class="percentage"></span><div class="uploadifyProgress"><div id="'+b(this).attr("id")+d+'ProgressBar" class="uploadifyProgressBar"><!--Progress Bar--\></div></div></div>')}});b(this).bind("uploadifySelectOnce", {action:a.onSelectOnce},function(c,d){c.data.action(c,d);if(a.auto)a.checkScript?b(this).uploadifyUpload(null,false):b(this).uploadifyUpload(null,true)});b(this).bind("uploadifyQueueFull",{action:a.onQueueFull},function(c,d){c.data.action(c,d)!==false&&alert("The queue is full. The max size is "+d+".")});b(this).bind("uploadifyCheckExist",{action:a.onCheck},function(c,d,g,e,j){var l={};l=g;l.folder=e.substr(0,1)=="/"?e:i+e;if(j)for(var q in g)var r=q;b.post(d,l,function(o){for(var p in o)if(c.data.action(c, o,p)!==false)confirm("Do you want to replace the file "+o[p]+"?")||document.getElementById(b(c.target).attr("id")+"Uploader").cancelFileUpload(p,true,true);j?document.getElementById(b(c.target).attr("id")+"Uploader").startFileUpload(r,true):document.getElementById(b(c.target).attr("id")+"Uploader").startFileUpload(null,true)},"json")});b(this).bind("uploadifyCancel",{action:a.onCancel},function(c,d,g,e,j,l){if(c.data.action(c,d,g,e,l)!==false)if(j){c=l==true?0:250;b("#"+b(this).attr("id")+d).fadeOut(c, function(){b(this).remove()})}});b(this).bind("uploadifyClearQueue",{action:a.onClearQueue},function(c,d){var g=a.queueID?a.queueID:b(this).attr("id")+"Queue";d&&b("#"+g).find(".uploadifyQueueItem").remove();c.data.action(c,d)!==false&&b("#"+g).find(".uploadifyQueueItem").each(function(){var e=b(".uploadifyQueueItem").index(this);b(this).delay(e*100).fadeOut(250,function(){b(this).remove()})})});var m=[];b(this).bind("uploadifyError",{action:a.onError},function(c,d,g,e){if(c.data.action(c,d,g,e)!== false){m.push([d,g,e]);b("#"+b(this).attr("id")+d).find(".percentage").text(" - "+e.type+" Error");b("#"+b(this).attr("id")+d).find(".uploadifyProgress").hide();b("#"+b(this).attr("id")+d).addClass("uploadifyError")}});typeof a.onUpload=="function"&&b(this).bind("uploadifyUpload",a.onUpload);b(this).bind("uploadifyProgress",{action:a.onProgress,toDisplay:a.displayData},function(c,d,g,e){if(c.data.action(c,d,g,e)!==false){b("#"+b(this).attr("id")+d+"ProgressBar").animate({width:e.percentage+"%"},250, function(){e.percentage==100&&b(this).closest(".uploadifyProgress").fadeOut(250,function(){b(this).remove()})});if(c.data.toDisplay=="percentage")displayData=" - "+e.percentage+"%";if(c.data.toDisplay=="speed")displayData=" - "+e.speed+"KB/s";if(c.data.toDisplay==null)displayData=" ";b("#"+b(this).attr("id")+d).find(".percentage").text(displayData)}});b(this).bind("uploadifyComplete",{action:a.onComplete},function(c,d,g,e,j){if(c.data.action(c,d,g,unescape(e),j)!==false){b("#"+b(this).attr("id")+ d).find(".percentage").text(" - Completed");a.removeCompleted&&b("#"+b(c.target).attr("id")+d).fadeOut(250,function(){b(this).remove()});b("#"+b(c.target).attr("id")+d).addClass("completed")}});typeof a.onAllComplete=="function"&&b(this).bind("uploadifyAllComplete",{action:a.onAllComplete},function(c,d){if(c.data.action(c,d)!==false)m=[]})})},uploadifySettings:function(h,a,i){var f=false;b(this).each(function(){if(h=="scriptData"&&a!=null){var d=i?a:b.extend(b(this).data("settings").scriptData,a), g="",e;for(e in d)g+="&"+e+"="+d[e];a=escape(g.substr(1))}f=document.getElementById(b(this).attr("id")+"Uploader").updateSettings(h,a)});if(a==null)if(h=="scriptData"){for(var n=unescape(f).split("&"),k={},m=0;m<n.length;m++){var c=n[m].split("=");k[c[0]]=c[1]}f=k}return f},uploadifyUpload:function(h,a){b(this).each(function(){a||(a=false);document.getElementById(b(this).attr("id")+"Uploader").startFileUpload(h,a)})},uploadifyCancel:function(h){b(this).each(function(){document.getElementById(b(this).attr("id")+ "Uploader").cancelFileUpload(h,true,true,false)})},uploadifyClearQueue:function(){b(this).each(function(){document.getElementById(b(this).attr("id")+"Uploader").clearFileUploadQueue(false)})}})}(jQuery);

/*Quick confirm http://blog.pierrejeanparra.com/jquery-plugins/fast-confirm/downloads*/
(function(b){b.fn.fastConfirm=function(l){var a;if(!this.length)return this;b.fastConfirm={defaults:{position:"bottom",offset:{top:0,left:0},zIndex:1E4,questionText:"Are you sure?",proceedText:"Yes",cancelText:"No",fastConfirmClass:"fast_confirm",onProceed:function(){},onCancel:function(){}}};a=b.extend(b.fastConfirm.defaults,l||{});return this.each(function(){var h,d,e,f=this,j=b('<button class="'+a.fastConfirmClass+'_proceed">'+a.proceedText+"</button>"),k=b('<button class="'+a.fastConfirmClass+ '_cancel">'+a.cancelText+"</button>"),c=b('<div class="'+a.fastConfirmClass+'"><div class="'+a.fastConfirmClass+'_arrow_border"></div><div class="'+a.fastConfirmClass+'_arrow"></div>'+a.questionText+"<br/></div>"),i=b("div."+a.fastConfirmClass+"_arrow",c),g=b("div."+a.fastConfirmClass+"_arrow_border",c);h=b(f).offset();if(!b(f).data("fastconfirm_binded")){j.click(function(){a.onProceed(f);b(f).removeData("fastconfirm_binded");b(this).closest("div."+a.fastConfirmClass).remove()});k.click(function(){a.onCancel(f); b(f).removeData("fastconfirm_binded");b(this).closest("div."+a.fastConfirmClass).remove()});c.append(j).append(k);b("body").append(c);switch(a.position){case "top":d=a.fastConfirmClass+"_bottom";e=a.fastConfirmClass+"_bottom";i.addClass(d).css("left",c.outerWidth()/2-i.outerWidth()/2);g.addClass(e).css("left",c.outerWidth()/2-g.outerWidth()/2);d=h.top-c.outerHeight()-g.outerHeight()+a.offset.top;e=h.left-c.outerWidth()/2+b(f).outerWidth()/2+a.offset.left;break;case "right":d=a.fastConfirmClass+"_left"; e=a.fastConfirmClass+"_left";i.addClass(d).css("top",c.outerHeight()/2-i.outerHeight()/2);g.addClass(e).css("top",c.outerHeight()/2-g.outerHeight()/2);d=h.top+b(f).outerHeight()/2-c.outerHeight()/2+a.offset.top;e=h.left+b(f).outerWidth()+g.outerWidth()+a.offset.left;break;case "bottom":d=a.fastConfirmClass+"_top";e=a.fastConfirmClass+"_top";i.addClass(d).css("left",c.outerWidth()/2-i.outerWidth()/2);g.addClass(e).css("left",c.outerWidth()/2-g.outerWidth()/2);d=h.top+b(f).outerHeight()+g.outerHeight()+ a.offset.top;e=h.left-c.outerWidth()/2+b(f).outerWidth()/2+a.offset.left;break;case "left":d=a.fastConfirmClass+"_right";e=a.fastConfirmClass+"_right";i.addClass(d).css("top",c.outerHeight()/2-i.outerHeight()/2);g.addClass(e).css("top",c.outerHeight()/2-g.outerHeight()/2);d=h.top+b(f).outerHeight()/2-c.outerHeight()/2+a.offset.top;e=h.left-c.outerWidth()-g.outerWidth()+a.offset.left}c.css({top:d,left:e,zIndex:a.zIndex});b(f).data("fastconfirm_binded",true)}})}})(jQuery);
...
/*Elastic textareas - http://www.unwrongest.com/projects/elastic/*/
