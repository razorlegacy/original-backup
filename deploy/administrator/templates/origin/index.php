...
<link href="templates/<?php echo  $this->template ?>/css/azure.css" rel="stylesheet" type="text/css" />
</head>
<body id="minwidth-body">
	<div id="border-top" class="<?php echo $this->params->get('headerColor','green');?>">
		<div>
			<div>
				<span class="version">
					<?php echo JText::_(" <strong>[Logged in: {$user->name}]</strong> "); ?>
					<?php echo  JText::_('Version') ?> 
					<?php echo  JVERSION; ?>
				</span>
				<span class="title">
					<?php echo $this->params->get('showSiteName') ? $mainframe->getCfg( 'sitename' ) : JText::_('Administration'); ?>
				</span>
			</div>
		</div>
	</div>
