...
/* Orochi */
var $j=jQuery.noConflict(),gaTrack,scrollTimer,currentTabId,iframeContent=[],flowplayer={},bitlyObj={version:"2.0.1",login:"sitech",apiKey:"R_f280841d77f892adb1b2fae2c47ae78f",history:"0"},_gaq=_gaq||[];_gaq.push(["_setAccount","UA-12310597-3"]);_gaq.push(["_trackPageview"]);var ga=document.createElement("script");ga.type="text/javascript";ga.async=!0;ga.src=("https:"==document.location.protocol?"https://ssl":"http://www")+".google-analytics.com/ga.js";var s=document.getElementsByTagName("script")[0];
s.parentNode.insertBefore(ga,s);
(function(c){var e="http://"+window.location.hostname,g=window.location.href;emcOrochi={_analyticTracker:function(b,a){if(gaTrack&&"undefined"!=typeof a)switch(b){case "click":_gaq.push(["_trackEvent","[Syndi] "+cfgObj.title+"-"+cfgObj.id+" [300x"+orochiType+"]","[Link] "+a]);break;case "cycle":var d=c(a).closest(".emcOrochi_group_wrapper").index(),f=c(a).index(),d=c.parseJSON(dataObj[currentTabId].group[d].content[f].content).title;_gaq.push(["_trackEvent","[Syndi] "+cfgObj.title+"-"+cfgObj.id+" [300x"+
orochiType+"]","[Page] "+d]);break;case "tabs":_gaq.push(["_trackEvent","[Syndi] "+cfgObj.title+"-"+cfgObj.id+" [300x"+orochiType+"]","[Tab] "+a]);break;case "init":_gaq.push(["_trackEvent","[Syndi] "+cfgObj.title+"-"+cfgObj.id+" [300x"+orochiType+"]","Load"])}},_convertHex:function(b,a){if(null!=b){var c=/^#([\da-fA-F]{2})([\da-fA-F]{2})([\da-fA-F]{2})$/.exec(b);return null!=a?"rgba("+parseInt(c[1],16)+", "+parseInt(c[2],16)+", "+parseInt(c[3],16)+", "+a+")":"rgb("+parseInt(c[1],16)+", "+parseInt(c[2],
16)+", "+parseInt(c[3],16)+")"}},_getHashParams:function(){var b=window.location.hash.substring(1);return b=decodeURIComponent(b.replace("header_2=",""))},_iframeFunc:function(b,a){void 0==c(b).contents().find("body").attr("style")?c(b).load(function(){c(b)[0].contentWindow.emcOrochi_iframe.init(a)}):c(b)[0].contentWindow.emcOrochi_iframe.init(a)},_scrollbar:function(){scrollTimer&&(clearTimeout(scrollTimer),scrollTimer=0);c(".jspDrag").fadeIn(300);scrollTimer=setTimeout(function(){c(".jspDrag").fadeOut(500)},
1E3)},init:function(b,a){c.getJSON(b,"",function(b){orochiObj=b;orochiObj.dfp=emcOrochi._getHashParams();cfgObj=orochiObj.config;dataObj=orochiObj.data;orochiType=a;gaTrack=!0;emcOrochi._analyticTracker("init","");emcOrochiTemplate.body();emcOrochi.groups(cfgObj);emcOrochi.tabs()})},groups:function(b){c(".emcOrochi_group").each(function(){if(1<c(this).children(".emcOrochi_cycle").length){var a=c(this);c(this).siblings(".emcOrochi_group_pager").removeClass("emcOrochi-hidden");c(this).siblings(".emcOrochi_group_pager").find(".emcOrochi_group_pager_index").empty();
c(a).cycle({after:function(){c(this).removeClass("emcOrochi_cycle_hide");c(this).siblings().addClass("emcOrochi_cycle_hide")},before:function(){},fx:b.cycle_fx,manualTrump:!1,next:c(a).siblings(".emcOrochi_group_pager").find(".emcOrochi_group_pager_next"),onPagerEvent:function(a,b){c(b).find(".emcOrochi_iframe").each(function(){emcOrochi._iframeFunc(c(this),"show")});c(b).siblings(".emcOrochi_cycle").find(".emcOrochi_iframe").each(function(){emcOrochi._iframeFunc(c(this),"hide")});emcOrochi._analyticTracker("cycle",
b)},onPrevNextEvent:function(a,b,e){c(e).find(".emcOrochi_iframe").each(function(){emcOrochi._iframeFunc(c(this),"show")});c(e).siblings(".emcOrochi_cycle").find(".emcOrochi_iframe").each(function(){emcOrochi._iframeFunc(c(this),"hide")});emcOrochi._analyticTracker("cycle",e)},pager:c(a).siblings(".emcOrochi_group_pager").find(".emcOrochi_group_pager_index"),pagerAnchorBuilder:function(a){return'<a href="#" class="emcOrochi-inline">'+a+"</a>"},prev:c(a).siblings(".emcOrochi_group_pager").find(".emcOrochi_group_pager_prev"),
speed:b.cycle_speed,timeout:0})}})},tabs:function(){c("#emcOrochi_body").tabs({select:function(b,a){var d=c.data(a.tab,"load.tabs");if(d)return window.open(d,"_blank"),!1;emcOrochi._analyticTracker("tabs",c(a.tab).text());return!0},show:function(b,a){currentTabId=a.index;currentTabText=a.tab.text;c(a.panel).find(".emcOrochi_cycle .emcOrochi_iframe").not(".emcOrochi_cycle_hide .emcOrochi_iframe").each(function(){emcOrochi._iframeFunc(c(this),"show")});c(".ui-tabs-hide").find(".emcOrochi_iframe").each(function(){emcOrochi._iframeFunc(c(this),
"hide")})}})}};emcOrochiTemplate={_groupContent:function(b,a){var d="",f="";for(cid in a[b].content)f=c.parseJSON(a[b].content[cid].content),f.id=a[b].content[cid].id,d+=emcOrochiTypes.init(f,f.id);return d},_scrollable:function(){c(".emcOrochi-scrollable").jScrollPane({autoReinitialise:!0});c("#emcOrochi_wrapper").mousemove(function(){emcOrochi._scrollbar()}).scroll(function(){emcOrochi._scrollbar()})},body:function(){emcOrochiTemplate.css(cfgObj);c("#emcOrochi_header").append(emcOrochiTemplate.header());
c("#emcOrochi_body").append(emcOrochiTemplate.pages());emcOrochiTemplate._scrollable();c("a.emcClickOff").click(function(){emcOrochi._analyticTracker("click",c(this).attr("href"));setTimeout('window.open("'+c(this).attr("href")+'")',100);return!1});"true"==cfgObj.social_show&&emcOrochiTemplate.social()},css:function(b){var a="<style>";b.syndi_bg_250&&(a+=".emcOrochi_250{background:transparent url("+e+b.syndi_bg_250+") no-repeat 0 0;}");b.syndi_bg_600&&(a+=".emcOrochi_600{background:transparent url("+
e+b.syndi_bg_600+") no-repeat 0 0;}");a+=".emcOrochi_tab{background:"+b.tab_bg_hex+";}";a+=".emcOrochi_tab a{color:"+b.tab_text_hex+"}";a+=".emcOrochi_tab:hover,.emcOrochi_tab.ui-tabs-selected{background:"+b.tab_bg_hover_hex+"}";a+=".emcOrochi_tab:hover a,.emcOrochi_tab.ui-tabs-selected a {color:"+b.tab_text_hover_hex+"}";a+=".emcOrochi_title{color:"+b.title_hex+"}";a+=".emcOrochi_content{color:"+b.content_hex+"}";a+="a.emcOrochi_link{color:"+b.link_hex+"}";a+="a.emcOrochi_link:hover{color:"+b.link_hover_hex+
"}";a+=".emcOrochi_group_pager{background-color:"+emcOrochi._convertHex(b.pagination_bg_hex,b.pagination_bg_opacity/100)+"}";a+=".emcOrochi_group_pager a{color:"+b.pagination_link_hex+"}";a+=".emcOrochi_group_pager a:hover{color:"+b.pagination_link_hover_hex+"}";a+=".emcOrochi_group_pager_index a{background-color:"+b.pagination_link_hex+"}";a+=".emcOrochi_group_pager_index a:hover,.emcOrochi_group_pager_index a.activeSlide{background-color:"+b.pagination_link_hover_hex+"}";a+=".emcOrochi-scrollable .jspDrag{background-color:"+
b.scrollbar_hex+"}";a+=b.css;c("head").append(a+"</style>")},header:function(){var b="";cfgObj.header_click_1&&(b+='<a href="'+cfgObj.header_click_1+'" id="emcOrochi_headerClick_left" class="emcClickOff"></a>');orochiObj.dfp&&(b+='<a href="'+orochiObj.dfp+'" id="emcOrochi_headerClick" class="emcClickOff"></a>');return b},groups:function(b){var a="";for(gid in b.group)a+='<div class="emcOrochi_group_wrapper">',"250"==orochiType&&1==b.group[gid].link&&b.group[gid].content?(a+='<div class="emcOrochi_group emcOrochi_group_size_1">',
a+=emcOrochiTemplate._groupContent(gid,b.group),a+="</div>"):"600"==orochiType&&(a+='<div class="emcOrochi_group emcOrochi_group_size_'+b.group[gid].size+'">',a+=emcOrochiTemplate._groupContent(gid,b.group),a+="</div>"),a+=emcOrochiTemplate.pager(),a+="</div>";return a},pager:function(){return'<div class="emcOrochi_group_pager emcOrochi-hidden"><a href="#" class="emcOrochi_group_pager_prev emcOrochi-inline"><</a><div class="emcOrochi_group_pager_index emcOrochi-inline"></div><a href="#" class="emcOrochi_group_pager_next emcOrochi-inline">></a></div>'},
pages:function(){var b,a,d=100/dataObj.length,f="250"==orochiType?cfgObj.tab_position_250:cfgObj.tab_position_600;b='<ul id="emcOrochi_menu" class="emcOrochi-list-inline emcOrochi_menu_'+f+'">';for(id in dataObj){a=c.parseJSON(dataObj[id].content);var e=a.link?a.link:"#emcOrochi_"+dataObj[id].id;b+='<li style="width: '+d+"%;height: 100%;"+(a.menu_bg?"background-image: url("+a.menu_bg+"); font-size:0px":"")+'" class="emcOrochi_tab '+(a.menu_bg?"emcOrochi_tab_bg":"emcOrochi_tab_hex")+'">';b+='<a href="'+
e+'">'+a.title+"</a>";b+="</li>"}b+="</ul>";for(id in dataObj)a=c.parseJSON(dataObj[id].content),a.link||(b+='<div id="emcOrochi_'+dataObj[id].id+'" class="ui-tabs-hide emcOrochi_page emcOrochi_page_'+f+'" style="'+(a.menu_page_bg?"background-image: url("+a.menu_page_bg+"); ":"")+'">',b+=emcOrochiTemplate.groups(dataObj[id]),b+="</div>");return b},social:function(){var b=c(".emcOrochi_page").position().top,a="",d="http://api.bit.ly/shorten?&longUrl="+encodeURIComponent(g)+"&login="+bitlyObj.login+
"&apiKey="+bitlyObj.apiKey+"&format=json&callback=?";c.getJSON(d,function(d){d=encodeURIComponent(d.results[g].shortUrl);a+='<div id="emcOrochi_social" style="top: '+b+'px">';a+='<a href="https://www.facebook.com/sharer.php?u='+d+'" class="emcOrochi_social_facebook emcClickOff">Facebook</a>';a+='<a href="https://twitter.com/share?url='+d+"&text="+cfgObj.social_description+'" class="emcOrochi_social_twitter emcClickOff">Twitter</a>';a+="</div>";c("#emcOrochi_body").prepend(a)})}};emcOrochiTypes={init:function(b,
a){var c;c=""+('<div id="" class="emcOrochi_'+b.type+' emcOrochi_cycle">');c+=emcOrochiTypes.load(b,a);return c+"</div>"},load:function(b,a){switch(b.type){case "article":return emcOrochiTypes.article(b,a);case "embed":case "video":return emcOrochiTypes.iframe(b,a);case "facebook":return emcOrochiTypes.facebook(b);case "image":return emcOrochiTypes.image(b);case "rss":return emcOrochiTypes.rss(b,a);case "twitter":return emcOrochiTypes.twitter(b,a)}},article:function(b){var a;a='<div class="emcOrochi_full"><div class="emcOrochi-scrollable">';
b.image&&(a+='<img src="'+e+b.image+'" class="emcOrochi_article_image"/>');a+='<div class="emcOrochi_content">';b.link&&(a+='<a href="'+b.link+'" class="emcClickOff">');a+='<h2 class="emcOrochi_title">'+b.title+"</h2>";b.link&&(a+="</a>");a+=b.content;a+="</div></div>";b.link&&(a+='<a href="'+b.link+'" class="emcOrochi_link emcClickOff">Read More</a>');return a+"</div>"},iframe:function(b,a){iframeContent["emcContent_"+a]=b;return'<iframe class="emcOrochi_iframe" id="emcOrochi_iframe_'+a+'" src="'+
e+"/components/com_orochi/assets/orochi/helper/iframe.php?cid="+a+'" scrolling="no" frameBorder="0" width="100%" height="100%" allowTransparency="true"></iframe>'},image:function(b){var a;a=""+(b.clickURL?'<a href="'+b.clickURL+'" class="emcClickOff">':"");a+='<img src="'+b.image+'"/>';return a+=b.clickURL?"</a>":""},rss:function(b){return rss='<iframe src="'+e+"/components/com_orochi/assets/orochi/helper/rss.php?feed_url="+b.feed_url+"&items="+b.articles_number+'" frameborder="0" width="300px" height="95%"></iframe>'},
twitter:function(b,a){var c;c='<div class="emcOrochi_full"><div class="emcOrochi-scrollable">'+('<div id="emcOrochi_twitter_'+a+'" class="emcOrochi_tweets"></div>')+('<script>$j(".emcOrochi_250 #emcOrochi_twitter_'+a+", .emcOrochi_600 #emcOrochi_twitter_"+a+'").liveTwitter("'+b.username+'", {mode: "user_timeline", refresh: false});<\/script>');return c+"</div></div>"}}})(jQuery);