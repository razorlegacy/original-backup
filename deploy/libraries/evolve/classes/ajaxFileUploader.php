...
class UploadHandler
{
    ...
    function __construct($options=null) {
        $this->options = array(
			...
			'upload_dir' => $_SERVER["DOCUMENT_ROOT"].$_POST['uploadDir'],
            'upload_url' => $_SERVER["DOCUMENT_ROOT"].$_POST['uploadDir'],
            'param_name' => 'files',
            ...
            'image_versions' => array(
              ...
              /*
  'thumbnail' => array(
					//'upload_dir' => $_SERVER["DOCUMENT_ROOT"].$_POST['uploadTemp'],
                    //'upload_url' => $_SERVER["DOCUMENT_ROOT"].$_POST['uploadTemp'],
                    'max_width' => 80,
                    'max_height' => 80
                )
*/
	...
	public function renameFile($file_name) {
		/** rename file ***/
		 ...
		 $new_file_name = $timestamp.".".end($extension);
