...
$PHPTHUMB_CONFIG['cache_directory'] = $_SERVER['DOCUMENT_ROOT'].'/assets/cache/';                            // set the cache directory relative to the phpThumb() installation
...
$PHPTHUMB_CONFIG['cache_source_directory'] = $_SERVER['DOCUMENT_ROOT'].'/assets/cache/source/';  // set the cache directory for unprocessed source images
