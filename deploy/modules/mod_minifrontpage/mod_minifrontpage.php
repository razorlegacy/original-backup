...
$cdn_url	=  $config->getValue('cdn_url', false);
$base		=  ($cdn_url) ? $cdn_url.'/' : JURI::base();
...
if(!defined('MOD_MINIFRONTPAGE_BASE')) {
	...
	$document->addCustomTag( '<link rel="stylesheet" type="text/css" href="'. $base . 'modules/mod_minifrontpage/css/style.css" title="default" />' );
}
if(!defined('MOD_MINIFRONTPAGE_BASEURL')) {
	define('MOD_MINIFRONTPAGE_BASEURL', $base.$params->get('image_path', 'images/stories'));
}
...
if(!defined('MOD_MINIFRONTPAGE_THUMB_BASEURL')) {
	define('MOD_MINIFRONTPAGE_THUMB_BASEURL', $base.$params->get('image_path', 'images/stories/minifp/'));
}
...
if(!defined('MOD_MINIFRONTPAGE_DEFAULT_BASEURL')) {
	define('MOD_MINIFRONTPAGE_DEFAULT_BASEURL', $base.$params->get('image_path', 'modules/mod_minifrontpage/images'));
}
